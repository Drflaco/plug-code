...
namespace plug::ui::v1
{
    ...
    //==========================================================================
    AboutPanel::AboutPanel (Presenter& presenter) : Panel ("À propos")
    {
        ...
        note.setText ("JUCE, le catalogue des effets et leurs versions : étape 6.", juce::dontSendNotification);
    ...
    //==========================================================================
    PrefsPanel::PrefsPanel() : Panel ("Préférences — étape 6")
    {
        todo.setText ("Ratio, zoom, aide au survol et son délai, loi de mélange par défaut, "
                      ...
                      "Le fichier existe déjà : %APPDATA%\\LascauxLab\\Plug\\prefs.xml.",
